...
//    });
  ...
  @override
  Widget build(BuildContext context) {
    print("执行_JGHomePageState的build方法");
    return Scaffold(
      appBar: AppBar(
        title: Text("首页"),
      ),
      body: Center(
        child: JGAnimatedIcon(_sizeAnim),
      ),
...
class JGAnimatedIcon extends AnimatedWidget {
//  final Animation _sizeAnim;
  JGAnimatedIcon(Animation anim): super(listenable: anim);
